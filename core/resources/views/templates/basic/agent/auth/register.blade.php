                            ...
                            <div class="account-info text-center">
                                <div class="account-info__thumb mb-4">
                                    <a href="{{ route('home') }}"><img
                                            src="{{ frontendImage('login_register', @$registerContent->data_values->image) }}"
                                            alt="image"></a>
                                </div>
                            ...
                            <div class="account-form">
                                <div class="account-form__content mb-4">
                                    <h3 class="account-form__title mb-2">
                                        {{ __(@$registerContent->data_values->register_title) }}</h3>
                                    <p class="account-form__desc">
                                        {{ __(@$registerContent->data_values->register_subtitle) }}</p>
                                </div>
                                <form action="{{ route('agent.register') }}" method="POST" class="verify-gcaptcha ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="form-label form--label">@lang('First Name')</label>
                                                <input type="text" class="form-control form--control" name="firstname"
                                                    value="{{ old('firstname') }}" required id="name"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="email"
                                                    class="form--label form-label">@lang('E-Mail Address')</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="your-password" type="password"
                                                        class="form-control form--control" value="Password" name="password"
                                                        required>
                                                    <x-strong-password />
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="confirm-password"
                                                    class="form-label form--label">@lang('Confirm Password')</label>
                                                <div class="input-group">
                                                    <input id="confirm-password" type="password"
                                                        class="form-control form--control" value="Confirm Password"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <button type="submit" id="recaptcha"
                                                    class="btn btn--base w-100">@lang('Sign Up')</button>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
